    ...
    <div style={styles.container}>
      ...
      {showFilters && (
        <div style={styles.quickFilters}>
          ...
          <button
            onClick={() => handleChange('status', localFilters.status === 'todo' ? 'all' : 'todo')}
            style={{
          ...
          <button
            onClick={() => handleChange('status', localFilters.status === 'in-progress' ? 'all' : 'in-progress')}
            style={{
              ...styles.quickFilterButton,
          ...
          <button
            onClick={() => handleChange('priority', localFilters.priority === 'high' ? 'all' : 'high')}
            style={{
              ...styles.quickFilterButton,
